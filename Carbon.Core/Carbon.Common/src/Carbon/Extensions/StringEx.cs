...
public static class StringEx
{
	...
	{
		if (!uint.TryParse(value, out var result)) result = @default;
	...
	{
		if (!decimal.TryParse(value, out var result)) result = @default;
	...
	{
		if (!long.TryParse(value, out var result)) result = @default;
	...
	{
		if (!ulong.TryParse(value, out var result)) result = @default;
